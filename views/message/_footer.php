...
?>
<div class="row" id="yboard-footer">
		<div class="online col-md-9">
			<div>
				<span class="header2"><?php echo YBoard::t('yboard','{{guests}} guest(s) and {{members}} active member(s)', ['{guests}'=>($guests), '{members}'=>$members]);?></span>
            ...
            <div>
				<?php $members = YBoardMember::find()->presentScope()->all(); 
					...
					$spiders = \app\modules\yboard\models\YBoardSpider::find()->all();//present()->findAll();
